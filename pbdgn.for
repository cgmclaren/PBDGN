...
C 113  FORMAT(/' REP',I3/' BLK\PLOT=',I3,19I4)
C      IF(KEYLAT.EQ.2) WRITE (LU2,114) IREP,(JJ,JJ=1,JNT)
C 114  FORMAT(/' REP',I3/' ROW\COL =',I3,19I4)
